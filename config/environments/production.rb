...
AudioBox::Application.configure do
  ...
  config.paths['log'] = "/var/log/mongrel/audioBox.#{Rails.env}.log"
...
# current host
HOST='audiobox.uoc.edu'
HOST_DV='audiobox.uoc.edu'
HOST_CV='cv.uoc.edu'
PATH_PREFIX = '/rb/audioBox'
PATH_SWF = "#{PATH_PREFIX}/js"
PATH_UPLOAD_PREFIX = '/home/campus/railsHome/rb/audioBox/'
...
START_PAGE="http://#{HOST}#{PATH_PREFIX}/folders"
SIGNOUT_HOST = "http://#{HOST}#{PATH_PREFIX}/signout"
